...
#pragma clang diagnostic pop
    ...
    self.circleView.backgroundColor = iconColor;
...
{
    [self showTitle:vc image:nil color:color iconColor:iconColor borderColor:borderColor title:title subTitle:subTitle duration:duration completeText:closeButtonTitle style:Success];
}
...
{
    [self showTitle:vc image:nil color:color iconColor:iconColor borderColor:borderColor title:title subTitle:subTitle duration:duration completeText:closeButtonTitle style:Error];
}
...
{
    [self showTitle:vc image:nil color:color iconColor:iconColor borderColor:borderColor title:title subTitle:subTitle duration:duration completeText:closeButtonTitle style:Notice];
}
...
{
    [self showTitle:vc image:nil color:color iconColor:iconColor borderColor:borderColor title:title subTitle:subTitle duration:duration completeText:closeButtonTitle style:Warning];
}
...
{
    [self showTitle:vc image:nil color:color iconColor:iconColor borderColor:borderColor title:title subTitle:subTitle duration:duration completeText:closeButtonTitle style:Info];
}
...
{
    [self showTitle:vc image:nil color:color iconColor:iconColor borderColor:borderColor title:title subTitle:subTitle duration:duration completeText:closeButtonTitle style:Edit];
}
...
{
    [self showTitle:vc image:nil color:color iconColor:iconColor borderColor:borderColor title:title subTitle:subTitle duration:duration completeText:closeButtonTitle style:style];
}
...
{
    [self showTitle:vc image:image color:color iconColor:iconColor borderColor:borderColor title:title subTitle:subTitle duration:duration completeText:closeButtonTitle style:Custom];
}
...
- (void)showWaiting:(UIViewController *)vc color:(UIColor *)color iconColor:(UIColor *)iconColor borderColor:(UIColor *)borderColor title:(NSString *)title subTitle:(NSString *)subTitle closeButtonTitle:(NSString *)closeButtonTitle duration:(NSTimeInterval)duration
{
    ...
    [self showTitle:vc image:nil color:color iconColor:iconColor borderColor:borderColor title:title subTitle:subTitle duration:duration completeText:closeButtonTitle style:Waiting];
}
